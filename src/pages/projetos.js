...
function Projetos() {
  return (
    <div className='ps-container'>
      ...
      <div className="ps-projects-container">
        <div className="ps-project">
          ...
          <div className="ps-project-info">
            <h3 className="ps-project-title">Núcleo de Investment Banking - 2024.2 - Banco Safra</h3>
        ...
        <div className="ps-project">
          ...
          />
          <div className="ps-project-info">
            <h3 className="ps-project-title">Núcleo de Public Equity - 2023.2 - Vista Capital            </h3>
        ...
        <div className="ps-project">
          ...
          />
          <div className="ps-project-info">
            <h3 className="ps-project-title">Núcleo de Private Equity - 2024.2 - H.I.G Capital </h3>
        ...
        <div className="ps-project">
          ...
          />
          <div className="ps-project-info">
            <h3 className="ps-project-title">Núcleo de Global Equity - 2024.2 - Arbor Capital</h3>
        ...
        <div className="ps-project">
          ...
          />
          <div className="ps-project-info">
            <h3 className="ps-project-title">Núcleo de Private Equity - 2024.1 - Vinci</h3>
        ...
        <div className="ps-project">
          ...
          />
          <div className="ps-project-info">
            <h3 className="ps-project-title">Núcleo de Public Equity - 2024.1 - Tork Capital</h3>
        ...
        <div className="ps-project">
          ...
          />
          <div className="ps-project-info">
            <h3 className="ps-project-title">Núcleo de Investment Banking - 2023.2 - UBS</h3>
